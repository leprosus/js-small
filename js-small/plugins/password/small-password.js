        ...
        if(small.typeIn(password, "string,number")){
            ...
            if (password.length > 0){
                ...
                for (var index = 0; index < length; index++) {
                    ...
                    if (alpha.indexOf(chars) != -1) flags.alpha = true;
                    else if (upper.indexOf(chars) != -1) flags.upper = true;
                    else if (digits.indexOf(chars) != -1) flags.digit = true;
                    else if (simbols.indexOf(chars) != -1) flags.simbol = true;
                ...
                if (flags.digit) charset += digitChars;
                if (flags.simbol) charset += simbolsChars;
